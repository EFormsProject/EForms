...
extern void F506_2247(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {TABLE}.bag_put */
void F506_2247 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 505, Current, 0, 1, 2597);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(505, Current, 2597);
	RTCC(arg1, 505, l_feature_name, 1, RTWCT(1939, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
