...
extern EIF_TYPED_VALUE F517_3887(EIF_REFERENCE);
...
EIF_TYPED_VALUE F517_3887 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 516, Current, 0, 0, 4330);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(516, Current, 4330);
	RTIV(Current, RTAL);
