...
extern EIF_TYPED_VALUE F332_3887(EIF_REFERENCE);
...
EIF_TYPED_VALUE F332_3887 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 331, Current, 0, 0, 4326);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(331, Current, 4326);
	RTIV(Current, RTAL);
