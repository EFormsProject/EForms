...
extern EIF_TYPED_VALUE F36_654(EIF_REFERENCE);
...
{
	GTCX
	RTOTC (F36_653,710,RTMS_EX_H("Server: Standalone Eiffel Server",32,1003060338));
}
...
void F36_657 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 35, Current, 0, 0, 713);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(35, Current, 713);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
void F36_658 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 35, Current, 0, 0, 714);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(35, Current, 714);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
void F36_659 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 35, Current, 0, 0, 715);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(35, Current, 715);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
