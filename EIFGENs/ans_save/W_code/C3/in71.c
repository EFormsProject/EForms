...
extern void F71_1220(EIF_REFERENCE, EIF_TYPED_VALUE);extern void en_local_host_name(EIF_POINTER);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 70, Current, 1, 0, 1225);
	RTSA(Dtype(Current));
	RTSC;
	...
	up1 = tp1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(1146, Dtype(Current)))(Current, up1x);
	RTHOOK(3);
...
#define Result RTOTRR
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {510,265,0xFFFF};
		EIF_TYPE typres0;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 70, Current, 0, 0, 1227);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(70, Current, 1227);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000047, 0,0); /* Result */
	tr1 = RTLN(eif_new_type(73, 0x01).id);
...
void F71_1220 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 70, Current, 0, 1, 1228);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(70, Current, 1228);
