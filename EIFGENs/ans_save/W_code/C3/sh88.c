...
extern EIF_TYPED_VALUE F88_1413(EIF_REFERENCE);
...
RTOID (F88_1413)
EIF_TYPED_VALUE F88_1413 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 87, Current, 0, 0, 1390);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(87, Current, 1390);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
