...
extern EIF_TYPED_VALUE F690_2217(EIF_REFERENCE);
extern void F690_7348(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F690_2217 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 689, Current, 0, 0, 2473);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(689, Current, 2473);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F690_7348 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 689, Current, 0, 7347);
	RTSA(dtype);
	RTME(dtype, 0);
