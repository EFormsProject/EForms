...
extern EIF_TYPED_VALUE F675_3887(EIF_REFERENCE);
...
EIF_TYPED_VALUE F675_3887 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 674, Current, 0, 0, 4332);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(674, Current, 4332);
	RTIV(Current, RTAL);
