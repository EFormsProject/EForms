...
extern EIF_TYPED_VALUE F666_4359(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F666_4360(EIF_REFERENCE);
extern EIF_TYPED_VALUE F666_4361(EIF_REFERENCE);
extern void F666_7376(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F666_4359 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 665, Current, 2, 1, 6812);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(665, Current, 6812);
			...
			if (tb1) {
				...
				for (;;) {
					...
					if (tb2) {
						...
						tw2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1987, "item", arg1))(arg1)).it_c4);
...
/* {LIST}.after */
EIF_TYPED_VALUE F666_4360 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 665, Current, 0, 0, 6813);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(665, Current, 6813);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F666_4361 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 665, Current, 0, 0, 6814);
	RTSA(Dtype(Current));
	RTSC;
...
/* {LIST}._invariant */
void F666_7376 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 665, Current, 0, 7375);
	RTSA(dtype);
	RTME(dtype, 0);
