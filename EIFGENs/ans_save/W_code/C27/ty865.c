...
extern EIF_TYPED_VALUE F865_3887(EIF_REFERENCE);
...
EIF_TYPED_VALUE F865_3887 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 864, Current, 0, 0, 4337);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(864, Current, 4337);
	RTIV(Current, RTAL);
