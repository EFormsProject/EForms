...
extern EIF_TYPED_VALUE F830_3887(EIF_REFERENCE);
...
EIF_TYPED_VALUE F830_3887 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 829, Current, 0, 0, 4336);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(829, Current, 4336);
	RTIV(Current, RTAL);
