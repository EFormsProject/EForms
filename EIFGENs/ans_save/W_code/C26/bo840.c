...
extern EIF_TYPED_VALUE F840_2217(EIF_REFERENCE);
extern void F840_7348(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F840_2217 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 839, Current, 0, 0, 2481);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(839, Current, 2481);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F840_7348 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 839, Current, 0, 7347);
	RTSA(dtype);
	RTME(dtype, 0);
