...
extern EIF_TYPED_VALUE F473_3887(EIF_REFERENCE);
...
EIF_TYPED_VALUE F473_3887 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 472, Current, 0, 0, 4329);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(472, Current, 4329);
	RTIV(Current, RTAL);
