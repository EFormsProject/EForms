...
{
	GTCX
	RTOTC (F26_585,662,RTMS_EX_H("English",7,257590376));
}
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 25, Current, 0, 0, 662);
	RTSA(Dtype(Current));
	RTSC;
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {416,0xFF01,296,0xFFFF};
		EIF_TYPE typres0;
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 25, Current, 0, 0, 663);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 25, Current, 0, 0, 664);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 25, Current, 0, 0, 657);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
{
	GTCX
	RTOTC (F26_590,659,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
{
	GTCX
	RTOTC (F26_591,660,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
{
	GTCX
	RTOTC (F26_592,661,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}
