...
extern void F9_120(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F9_120 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTCC(arg1, 8, l_feature_name, 1, RTWCT(120, Dtype(Current), Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 120, 0xF8000179, 0); /* path_parameters */
	RTAR(Current, arg1);
	*(EIF_REFERENCE *)(Current + RTWA(120, Dtype(Current))) = (EIF_REFERENCE) RTCCL(arg1);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
