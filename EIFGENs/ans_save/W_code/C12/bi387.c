...
extern EIF_TYPED_VALUE F387_2204(EIF_REFERENCE);
extern void F387_2207(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F387_7345(EIF_REFERENCE, int);
...
/* {BILINEAR}.off */
EIF_TYPED_VALUE F387_2204 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 386, Current, 0, 0, 2400);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(386, Current, 2400);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BILINEAR}.search */
void F387_2207 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 386, Current, 0, 1, 2401);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(386, Current, 2401);
	RTCC(arg1, 386, l_feature_name, 1, RTWCT(1940, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = '\0';
	tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1956, dtype))(Current)).it_b);
...
/* {BILINEAR}._invariant */
void F387_7345 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 386, Current, 0, 7344);
	RTSA(dtype);
	RTME(dtype, 0);
