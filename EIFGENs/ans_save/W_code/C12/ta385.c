...
extern void F385_2247(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {TABLE}.bag_put */
void F385_2247 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 384, Current, 0, 1, 2594);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(384, Current, 2594);
	RTCC(arg1, 384, l_feature_name, 1, RTWCT(1939, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
