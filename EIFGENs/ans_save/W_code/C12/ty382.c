...
extern EIF_TYPED_VALUE F382_3887(EIF_REFERENCE);
...
EIF_TYPED_VALUE F382_3887 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 381, Current, 0, 0, 4327);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(381, Current, 4327);
	RTIV(Current, RTAL);
