...
extern void F716_2247(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {TABLE}.bag_put */
void F716_2247 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu2_1 uu2_1x.it_n2
	...
	RTEAA(l_feature_name, 715, Current, 0, 1, 2601);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(715, Current, 2601);
	RTIV(Current, RTAL);
