...
extern EIF_TYPED_VALUE F705_4075(EIF_REFERENCE);
extern EIF_TYPED_VALUE F705_4078(EIF_REFERENCE);
extern void F705_7371(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F705_4075 (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F705_4078 (EIF_REFERENCE Current)
{
	GTCX
...
void F705_7371 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 704, Current, 0, 7370);
	RTSA(dtype);
	RTME(dtype, 0);
