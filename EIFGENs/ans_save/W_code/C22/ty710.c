...
extern EIF_TYPED_VALUE F710_3887(EIF_REFERENCE);
...
EIF_TYPED_VALUE F710_3887 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 709, Current, 0, 0, 4333);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(709, Current, 4333);
	RTIV(Current, RTAL);
