...
extern EIF_TYPED_VALUE F725_2217(EIF_REFERENCE);
extern void F725_7348(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F725_2217 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 724, Current, 0, 0, 2475);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(724, Current, 2475);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F725_7348 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 724, Current, 0, 7347);
	RTSA(dtype);
	RTME(dtype, 0);
