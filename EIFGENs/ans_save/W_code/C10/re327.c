...
extern EIF_TYPED_VALUE F327_4075(EIF_REFERENCE);
extern EIF_TYPED_VALUE F327_4078(EIF_REFERENCE);
extern void F327_7371(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F327_4075 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 326, Current, 0, 0, 5169);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(326, Current, 5169);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F327_4078 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 326, Current, 0, 0, 5170);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(326, Current, 5170);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F327_7371 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 326, Current, 0, 7370);
	RTSA(dtype);
	RTME(dtype, 0);
