...
extern EIF_TYPED_VALUE F313_7086(EIF_REFERENCE);
extern EIF_TYPED_VALUE F313_7087(EIF_REFERENCE);
extern EIF_TYPED_VALUE F313_7088(EIF_REFERENCE);
extern EIF_TYPED_VALUE F313_7090(EIF_REFERENCE);
extern void F313_7095(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F313_7086 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F313_7087 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F313_7088 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F313_7090 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 312, Current, 0, 0, 12395);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(312, Current, 12395);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	ur1 = tr2;
	tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(3975, "plus", tr1))(tr1, ur1x)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
...
void F313_7095 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 312, Current, 0, 1, 12396);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(312, Current, 12396);
	RTCC(arg1, 312, l_feature_name, 1, RTWCT(5438, Dtype(Current), Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 5438, 0xF80000F5, 0); /* breakable_info */
	RTAR(Current, arg1);
	*(EIF_REFERENCE *)(Current + RTWA(5438, Dtype(Current))) = (EIF_REFERENCE) RTCCL(arg1);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
