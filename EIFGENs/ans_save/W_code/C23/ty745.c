...
extern EIF_TYPED_VALUE F745_3887(EIF_REFERENCE);
...
EIF_TYPED_VALUE F745_3887 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 744, Current, 0, 0, 4334);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(744, Current, 4334);
	RTIV(Current, RTAL);
