...
extern EIF_TYPED_VALUE F164_2172(EIF_REFERENCE);
...
RTOID (F164_2172)
EIF_TYPED_VALUE F164_2172 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 163, Current, 0, 0, 2120);
	RTSA(Dtype(Current));
	RTSC;
