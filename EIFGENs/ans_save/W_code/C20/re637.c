...
extern EIF_TYPED_VALUE F637_4075(EIF_REFERENCE);
extern EIF_TYPED_VALUE F637_4078(EIF_REFERENCE);
extern void F637_7371(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F637_4075 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 636, Current, 0, 0, 5184);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(636, Current, 5184);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF800027D, 0,0); /* Result */
	{
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 636, Current, 0, 0, 5185);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(636, Current, 5185);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F637_7371 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 636, Current, 0, 7370);
	RTSA(dtype);
	RTME(dtype, 0);
