...
extern EIF_TYPED_VALUE F641_3887(EIF_REFERENCE);
...
EIF_TYPED_VALUE F641_3887 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 640, Current, 0, 0, 4331);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(640, Current, 4331);
	RTIV(Current, RTAL);
