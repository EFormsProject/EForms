...
extern EIF_TYPED_VALUE F236_4734(EIF_REFERENCE);
...
EIF_TYPED_VALUE F236_4734 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 235, Current, 0, 0, 8038);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(235, Current, 8038);
	RTIV(Current, RTAL);
	RTHOOK(1);
