...
extern EIF_TYPED_VALUE F798_2217(EIF_REFERENCE);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F798_2217 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 797, Current, 0, 0, 2479);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(797, Current, 2479);
	RTIV(Current, RTAL);
	RTHOOK(1);
