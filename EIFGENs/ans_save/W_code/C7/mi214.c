...
extern void F214_3761(EIF_REFERENCE);
extern EIF_TYPED_VALUE F214_3762(EIF_REFERENCE);
...
void F214_3761 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 213, Current, 2, 0, 4203);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(213, Current, 4203);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(3980, "to_string_8", tr1))(tr1)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
	ur1 = RTCCL(tr2);
...
RTOID (F214_3762)
EIF_TYPED_VALUE F214_3762 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 213, Current, 0, 0, 4204);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(213, Current, 4204);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
