...
extern EIF_TYPED_VALUE F928_2285(EIF_REFERENCE);
extern EIF_TYPED_VALUE F928_2286(EIF_REFERENCE);
extern void F928_2287(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F928_7351(EIF_REFERENCE, int);
...
/* {DISPENSER}.readable */
EIF_TYPED_VALUE F928_2285 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 927, Current, 0, 0, 2664);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(927, Current, 2664);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {DISPENSER}.writable */
EIF_TYPED_VALUE F928_2286 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 927, Current, 0, 0, 2665);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(927, Current, 2665);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1932, Dtype(Current)))(Current)).it_b);
...
/* {DISPENSER}.append */
void F928_2287 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 927, Current, 0, 1, 2666);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(927, Current, 2666);
	{
...
void F928_7351 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 927, Current, 0, 7350);
	RTSA(dtype);
	RTME(dtype, 0);
