...
extern void F425_4352(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F425_4355(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F425_4356(EIF_REFERENCE);
extern EIF_TYPED_VALUE F425_4357(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F425_4345 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 424, Current, 0, 0, 6726);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(424, Current, 6726);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F425_4346 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 424, Current, 0, 0, 6727);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(424, Current, 6727);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	Result = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
...
/* {DYNAMIC_CHAIN}.prune */
void F425_4352 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 424, Current, 0, 1, 6728);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(424, Current, 6728);
	RTCC(arg1, 424, l_feature_name, 1, RTWCT(1987, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
void F425_4355 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 424, Current, 0, 1, 6729);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(424, Current, 6729);
	RTCC(arg1, 424, l_feature_name, 1, RTWCT(1987, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F425_4356 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 424, Current, 0, 0, 6730);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(424, Current, 6730);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F425_4357 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 424, Current, 2, 1, 6731);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(424, Current, 6731);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
