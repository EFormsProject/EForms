...
extern EIF_TYPED_VALUE F921_1198(EIF_REFERENCE);
extern void F921_1199(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F921_1200(EIF_REFERENCE);
...
/* {LINKABLE}.right */
EIF_TYPED_VALUE F921_1198 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
/* {LINKABLE}.put_right */
void F921_1199 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 920, Current, 0, 1, 1213);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(920, Current, 1213);
	RTCC(arg1, 920, l_feature_name, 1, eif_new_type(Dftype(Current), 0), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 1128, 0xF8000398, 0); /* right */
	RTAR(Current, arg1);
...
void F921_1200 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 920, Current, 0, 0, 1214);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(920, Current, 1214);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 1128, 0xF8000398, 0); /* right */
