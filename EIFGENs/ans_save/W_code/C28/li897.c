...
extern EIF_TYPED_VALUE F897_1198(EIF_REFERENCE);
extern void F897_1199(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F897_1200(EIF_REFERENCE);
...
/* {LINKABLE}.right */
EIF_TYPED_VALUE F897_1198 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
/* {LINKABLE}.put_right */
void F897_1199 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 896, Current, 0, 1, 1210);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(896, Current, 1210);
	RTCC(arg1, 896, l_feature_name, 1, eif_new_type(Dftype(Current), 0), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 1128, 0xF8000380, 0); /* right */
	RTAR(Current, arg1);
...
void F897_1200 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 896, Current, 0, 0, 1211);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(896, Current, 1211);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 1128, 0xF8000380, 0); /* right */
