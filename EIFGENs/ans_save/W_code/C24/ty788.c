...
extern EIF_TYPED_VALUE F788_3887(EIF_REFERENCE);
...
EIF_TYPED_VALUE F788_3887 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 787, Current, 0, 0, 4335);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(787, Current, 4335);
	RTIV(Current, RTAL);
