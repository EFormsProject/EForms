...
extern void F100_1624(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F100_1625(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F100_1624 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 99, Current, 0, 1, 1586);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(99, Current, 1586);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F100_1625 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 99, Current, 0, 1, 1587);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(99, Current, 1587);
	RTCC(arg1, 99, l_feature_name, 1, eif_new_type(296, 0x01), 0x01);
	RTIV(Current, RTAL);
