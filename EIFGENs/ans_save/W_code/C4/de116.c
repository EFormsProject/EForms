...
extern EIF_TYPED_VALUE F116_1864(EIF_REFERENCE);
extern EIF_TYPED_VALUE F116_1865(EIF_REFERENCE);
...
EIF_TYPED_VALUE F116_1864 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 115, Current, 0, 0, 1817);
	RTSA(Dtype(Current));
	RTSC;
	...
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1114, 66))(Current)).it_i4);
...
RTOID (F116_1865)
EIF_TYPED_VALUE F116_1865 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 115, Current, 0, 0, 1818);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
